...
export const constellations: Constellation[] = [
  ...
  },
  {
    ...
    stars: [
      { x: 50, y: 70, brightness: 1.5 }, // Antares
      { x: 48, y: 68, brightness: 1.1 },
      { x: 46, y: 72, brightness: 1.1 },
      { x: 48, y: 75, brightness: 1.0 },
      { x: 52, y: 77, brightness: 1.1 },
      { x: 56, y: 78, brightness: 1.2 },
      { x: 60, y: 75, brightness: 1.1 },
      { x: 62, y: 72, brightness: 1.0 },
    ],
