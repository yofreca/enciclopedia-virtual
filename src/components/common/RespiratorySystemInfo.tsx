...
import { type RespiratoryPart } from '../../data/respiratorySystemData';

interface RespiratorySystemInfoProps {
  part: RespiratoryPart | null;
}

const RespiratorySystemInfo = ({ part }: RespiratorySystemInfoProps) => {
  return (
...
export default RespiratorySystemInfo;
