...
import { type CirculatoryPart } from '../../data/circulatorySystemData';

interface CirculatorySystemInfoProps {
  part: CirculatoryPart | null;
}

const CirculatorySystemInfo = ({ part }: CirculatorySystemInfoProps) => {
  return (
...
export default CirculatorySystemInfo;
